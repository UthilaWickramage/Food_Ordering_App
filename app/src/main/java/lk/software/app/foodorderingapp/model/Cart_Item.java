...
private double totalProductPrice;
    ...
    public Cart_Item(String name, String category, double price, int quantity, double totalProductPrice, String currentSaveDate, String currentSaveTime, String image) {
        this.id = id;
        this.name = name;
    ...
    public static List<Cart_Item> getAllOrderItems(){
        List<Cart_Item> orderItems = new ArrayList<>();
